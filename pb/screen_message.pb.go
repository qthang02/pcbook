...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=qthang02.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x71, 0x74, 0x68, 0x61, 0x6e, 0x67, 0x30, 0x32, 0x2e, 0x70,
	...
	0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x71, 0x74, 0x68, 0x61, 0x6e, 0x67, 0x30, 0x32, 0x2e, 0x70, 0x63,
	...
	0x53, 0x10, 0x01, 0x12, 0x08, 0x0a, 0x04, 0x4f, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x42, 0x0b, 0x5a,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: qthang02.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: qthang02.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: qthang02.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: qthang02.pcbook.Screen.resolution:type_name -> qthang02.pcbook.Screen.Resolution
	0, // 1: qthang02.pcbook.Screen.panel:type_name -> qthang02.pcbook.Screen.Panel
